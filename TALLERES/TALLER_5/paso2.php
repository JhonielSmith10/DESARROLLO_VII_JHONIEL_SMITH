...
echo "</br>Valor total del inventario: $" . valorTotalInventario($inventario) . "\n";
...
function productoMayorValor($inv) {
    ...
    return [$productoMayor, $maxValor];
}

$resultado = productoMayorValor($inventario);
$productoMayor = $resultado[0];
$valor = $resultado[1];
echo "</br>El producto con mayor valor total en inventario es $productoMayor con un valor de: \$$valor\n";
?>