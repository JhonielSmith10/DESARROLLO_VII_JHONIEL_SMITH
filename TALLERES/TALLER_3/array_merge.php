...
$misComidas = ["Pizza", "Arroz con Pollo", "Sopa"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Macarrones", "Lasaña", "Hamburguesa"]; // Reemplaza con las comidas favoritas de tu amigo
