...
$misAmigos = ["Ian", "Eduardo", "Victor"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Brian", "Edgar"); // Reemplaza las comillas vacías con los nombres de tus amigos
...
array_push($playlist, ["Billie Jean", "Michael Jackson"], ["Like a Rolling Stone", "Bob Dylan"], ["Enemy", "Imagine Dragons"]);
