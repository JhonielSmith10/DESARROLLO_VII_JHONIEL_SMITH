...
$frutas = ['manzana', 'banana', 'naranja', 'uva', 'pera', 'sandia','piña'];
...
$numerosLoteria = generarNumerosLoteria(6, 1, 100);
...
$intentos = 1000;
$exitos = 0;
$probabilidad = 50; // 30% de probabilidad
...
//juego de adivinar el numero simple
$numeroAdivinanza = 5;

$numeroElegido = rand(1, 10);

echo "el numero elegido por la maquina es: $numeroElegido </br>";
if ($numeroElegido == $numeroAdivinanza) {
    echo "Se adivino el numero. El número era $numeroElegido.</br>";
} else {
    echo "No he adivinado el número. .</br>";
}
?>
