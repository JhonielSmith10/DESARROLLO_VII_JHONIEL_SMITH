...
function crearEncabezado($texto) {
    return str_pad(strtoupper($texto), strlen($texto) + 6, "*", STR_PAD_BOTH);
}

$tituloDocumento = "Informe de suma importante";
...
$peliculaMayusculas =  array_map('strtoupper', $pelicula);
echo "</br>Frutas originales:</br>";
print_r($frutas);
echo "Frutas en mayúsculas:</br>";
print_r($frutasMayusculas);
echo "</br>Pelicula originales:</br>";
print_r($pelicula);
echo "</br>Pelicula en en mayúsculas:</br>";
print_r($peliculaMayusculas);
