...
$nombres = ["Ana", "Carlos", "Beatriz", "Jhoniel", "Ian"];
$apellidos = ["García", "Rodríguez", "López", "Smith", "Gonzales"];
...
$temperaturasFahrenheit = array_map('celsiusAFahrenheit', $temperaturasCelsius);
echo "Temperaturas en Celsius: " . implode(", ", $temperaturasCelsius) . "</br>";
echo "Temperaturas en Fahrenheit: " . implode(", ", $temperaturasFahrenheit) . "</br>";
?>
