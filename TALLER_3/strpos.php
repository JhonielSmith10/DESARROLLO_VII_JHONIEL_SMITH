...
$email3 = "jhoniel813@gmail.com";
$email4 = "jhoniel813/gmail.com";
...
echo "¿'$email3' es un email válido? " . (esEmailValido($email3) ? "Sí" : "No") . "</br>";
echo "¿'$email4' es un email válido? " . (esEmailValido($email4) ? "Sí" : "No") . "</br>";
...
$nombreUsuario = extraerNombreUsuario($email3);
echo "</br>Nombre de usuario extraído de '$email3': " . ($nombreUsuario !== false ? $nombreUsuario : "Email no válido") . "</br>";
...
$textoPrueba = "Este texto debe contener todas las palabras.";
$palabrasNecesarias = ["texto", "contener", "palabras"];
echo "</br>¿El texto contiene todas las palabras necesarias? " . (contienePalabras($textoPrueba, $palabrasNecesarias) ? "Sí" : "No") . "</br>";

function reemplazarPalabra($texto, $buscada, $reemplazo) {
    return str_replace($buscada, $reemplazo, $texto);
}

$textoModificado = reemplazarPalabra($textoOriginal, "palabras", "términos");
echo "</br>Texto original: $textoOriginal</br>";
