...
$calificaciones = [99.3, 50.5, 89.7, 89.1, 84.2];
...
$precios = [9.01, 10.49, 20.05, 5.75, 15.99, 4.64, 6.787];
...
$cantidad = 100/15; // Esto resulta en un número periódico
...
echo "Redondeado a 3 decimales: " . round($cantidad, 3) . "</br>";
?>
